...
The simulator is held to a statistical calibration contract, enforced by the test suite over a seeded simulated year. The median price is $\approx\$64$/MWh, the winter median more than \$6 above the summer median and the winter mean more than \$15 above it, the evening peak above overnight prices, scarcity below 1.5\% of hours, and negative prices rare but present. These tests are the contract that the market hasn't drifted when any fleet or weather parameter changes.
